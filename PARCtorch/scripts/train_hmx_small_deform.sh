#!/usr/bin/env bash
# ==============================================================================
# Training Script: HMX - Small Deform
# ==============================================================================
# Dataset: hmx
# Model: small_deform
# ==============================================================================
...
SAVE_DIR="/scratch/jtb3sud/Jesus/em/weights/small_deform"
LOSS_DIR="/scratch/jtb3sud/Jesus/em/loss/small_deform"
...
echo "=========================================="
echo "Training: HMX - Small Deform"
...
$PYTHON_PATH jesus.py \
    ...
    --load_mod "/scratch/jtb3sud/Jesus/em/weights/small_deform/checkpoint_epoch_1175.pth" \
