#!/usr/bin/env bash
# ==============================================================================
# Training Script: BURGERS - Large No Deform
# ==============================================================================
# Dataset: burgers
...
#SBATCH -J burgers_large_no_deform
...
SAVE_DIR="/scratch/jtb3sud/Jesus/burgers/weights/large_no_deform"
LOSS_DIR="/scratch/jtb3sud/Jesus/burgers/loss/large_no_deform"
...
echo "=========================================="
echo "Training: BURGERS - Large No Deform"
...
$PYTHON_PATH jesus.py \
    ...
    --load_mod "/scratch/jtb3sud/Jesus/burgers/weights/large_no_deform/latest_checkpoint.pth" \
