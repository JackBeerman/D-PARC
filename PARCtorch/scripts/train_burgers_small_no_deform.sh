#!/usr/bin/env bash
# ==============================================================================
# Training Script: BURGERS - Small No Deform
# ==============================================================================
# Dataset: burgers
...
#SBATCH -J burgers_small_no_deform
...
SAVE_DIR="/scratch/jtb3sud/Jesus/burgers/weights/small_no_deform"
LOSS_DIR="/scratch/jtb3sud/Jesus/burgers/loss/small_no_deform"
...
echo "=========================================="
echo "Training: BURGERS - Small No Deform"
...
$PYTHON_PATH jesus.py \
    ...
    --load_mod "/scratch/jtb3sud/Jesus/burgers/weights/small_no_deform/latest_checkpoint.pth" \
