#!/usr/bin/env bash
# ==============================================================================
# Training Script: NS - Small No Deform
# ==============================================================================
# Dataset: ns
...
SAVE_DIR="/scratch/jtb3sud/Jesus/ns/weights/small_no_deform"
LOSS_DIR="/scratch/jtb3sud/Jesus/ns/loss/small_no_deform"
...
echo "=========================================="
echo "Training: NS - Small No Deform"
...
$PYTHON_PATH train_ns.py \
    ...
    --load_mod "/scratch/jtb3sud/Jesus/ns/weights/small_no_deform/latest_checkpoint.pth" \
